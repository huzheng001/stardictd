...
if ($username!="" && $password!="") {
	echo "<br>"._L("Language:")." <select id=\"language\"><option value=\"default\">English</option><option value=\"zh_CN\">简体中文</option><option value=\"zh_TW\">繁體中文</option><option value=\"ru_RU\">Русский</option><option value=\"ko\">Korean</option><option value=\"de_DE\">Deutsch</option><option value=\"sk\">Slovak</option><option value=\"uyghur\">Uyghur</option></select> <input type=\"button\" value=\""._L("Apply")."\" onClick=\"apply_language()\" /> &nbsp;&nbsp; <a href=\"helptranslate.php\">Help us to translate</a><br>";
